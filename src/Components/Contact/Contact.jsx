                        ...
                        <div
                            ...
                            <div className="mb-24 grid gap-x-6 gap-y-4 md:grid-cols-2 lg:grid-cols-4 text-white">
                                <div className="mx-auto mb-12 text-center lg:mb-0">
                                    ...
                                    <h6 className="font-medium">Morocco</h6>
                                </div>
                                <div className="mx-auto mb-12 text-center lg:mb-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2"
                                        stroke="currentColor" className="mx-auto mb-6 h-8 w-8 text-primary">
                                    ...
                                    <h6 className="font-medium">Maracesh</h6>
                                </div>
                                <div className="mx-auto mb-12 text-center md:mb-0">
                                    ...
                                    <h6 className="font-medium">+212 619-629538</h6>
                                </div>
                                <div className="mx-auto text-center">
                                    ...
                                    <h6 className="font-medium">sarahassib687@gmail.com</h6>
                                </div>
                            </div>
                            <div className="form mx-auto max-w-[700px]">
                                ...
                                <form ref={form} onSubmit={sendMessage}>
                                    <div className="mb-8 flex flex-col gap-10">
                                        <Input size="lg" value={initialData.name} onChange={handleChange} label="Name" variant="standard" color="teal" name="name" className="text-white" />
                                        <Input size="lg" value={initialData.email} onChange={handleChange} label="Email" variant="standard" color="teal" name="email" className="text-white" />
